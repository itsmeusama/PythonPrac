...
for element in root.findall('Book'):
    ...
    if (count == 0):
        ...
        #Publc = element[5][0].tag
        #book_head.append(Publc)
    ...
    Publication = element[5][0].text
    publisher_list.append(Publication)
    Estb = element[5][1].text
    publisher_list.append(Estb)
